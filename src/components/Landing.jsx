...
const Landing = () => {
    ...
    const getData = () =>  {  
        ...
        .catch((err) => {
            ...
            console.log(err, "So we don't have this repo, but we DO have law degrees... maybe chug some Brawndo and try searching a cooler company?")
                    setBadSearchTerm(true)
                    setTimeout(() => {
                        setBadSearchTerm(false)}, 9000)
      ...
      <div className='left-hand-side-page'>
        ...
        <div className='search-container'>
          <form
            ...
            {badSearchTerm
                ? 
                    <div className='error-message'>So we don't have this repo, but we DO have law degrees... maybe chug some Brawndo and try searching a cooler company?</div>
                : 
                    null
            }
        ...
        <div classname='repo-list-container'>
            {displayRepoList()}
            {/* <RepoList parseData={searchResult} /> */}
        </div>
      </div> 
    </>
  )
